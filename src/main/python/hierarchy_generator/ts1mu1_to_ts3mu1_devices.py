...
class TS1MU1_TO_TS3MU1_DEVICES(INIT_GENERIC_TRANSFER_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "TS1MU1_TO_TS3MU1"

        self._main_dipoles = [ "GTS1MU2", "GTS3MU1" ]
        self._main_quadrupoles = [ "GTS1QD11", "GTS1QD12", "GTS2QT11", "GTS2QT12", "GTS2QT13" ]
