...
class HHTMU1_TO_HHT_DEVICES(INIT_GENERIC_TRANSFER_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "HHTMU1_TO_HHT"

        self._main_dipoles = [ "GHHTMU2", "GHHTMU3", "GHHTMU4" ]
        self._main_quadrupoles = [ "GHHTQD11", "GHHTQD12", "GHHTQD21", "GHHTQD22", "GHHTQT31", "GHHTQT32", "GHHTQT33" ]
...
#       self._main_sextupoles = self._resonance_sextupoles
        ...
        #self._vertical_correctors   = [ "GTS1KY1" ]
