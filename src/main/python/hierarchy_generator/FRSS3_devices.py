...
class FRSS3_DEVICES(INIT_FRS_MAIN_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "FRSS3"
       

        self._main_dipoles = [ "TS4MU1G" ]
        self._main_quadrupoles = [ "TS4QT11G", "TS4QT12G", "TS4QT13G", "TS4QD21G","TS4QD22G" ]
        self._targetladders = ["TS4ED4SG"]
        self._vertical_correctors = ["TS4KY1G","TS4KY2G"]
        self._main_sextupoles = ["TS4KS1G","TS4KS2G"]
