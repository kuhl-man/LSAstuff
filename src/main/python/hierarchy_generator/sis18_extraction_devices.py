...
class SIS18_EXTRACTION_DEVICES(INIT_GENERIC_TRANSFER_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "SIS18_EXTRACTION"
...
#       self._main_sextupoles = self._resonance_sextupoles
        ...
        #self._vertical_correctors   = [ "GTE1KY1", "GTS1KY1", "GHHDKY1", "GHHDKY2" ]
