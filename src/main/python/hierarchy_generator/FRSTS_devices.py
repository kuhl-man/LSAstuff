...
class FRSTS_DEVICES(INIT_FRS_MAIN_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "FRSTS"
       

        self._main_dipoles = [ "TS1MU1G", "TS1MU2G" ]
        self._main_quadrupoles = [ "TE1QD11G", "TE1QD12G", "TS1QD11G", "TS1QD12G" ]
        self._targetladders = ["TS1ET5G","TS2ET1G","TS2ET2G"]
