...
class TS1MU1_TO_TE3MU1_DEVICES(INIT_GENERIC_TRANSFER_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "TS1MU1_TO_TE3MU1"

        self._main_dipoles = [ "GTE3MU1" ]
        self._main_quadrupoles = [ "GTE2QT11", "GTE2QT12", "GTE2QT13" ]
...
#       self._main_sextupoles = self._resonance_sextupoles
        ...
        self._horizontal_correctors = [ "GTE2KX1" ]
