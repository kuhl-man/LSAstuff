...
from FRSS3_properties import FRSS3_PROPERTIES

from FRSS3_devices import FRSS3_DEVICES

from devicedata_xml_parser import XMLParser

class GENERATOR_FRSS3(GenericTransferlineHierarchy,FRSGeneralTargetHierarchy, INIT_LH_BUILDER):
    ...
    def __init__(self):
        ...
        if not hasattr(self, 'lh_builder'):
            ...
            FRSS3_properties = FRSS3_PROPERTIES()
            INIT_LH_BUILDER.__init__(self, FRSS3_properties)
        
        FRSS3_device_groups = FRSS3_DEVICES()
        GenericTransferlineHierarchy.__init__(self, FRSS3_device_groups)
        FRSGeneralTargetHierarchy.__init__(self,FRSS3_device_groups)
    ...
    def __buildSpecial(self):
        # build special part of hierarchy for FRSS3
         ...
         self.lh_builder.create_child_node('TS4ED4SG/E_OUT',['FRSS3_BEAM/ELEMENT','FRSS3_BEAM/ISOTOPE','FRSS3_BEAM/Q'])
