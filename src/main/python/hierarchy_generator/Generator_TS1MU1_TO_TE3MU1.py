...
from ts1mu1_to_te3mu1_devices import TS1MU1_TO_TE3MU1_DEVICES

class GENERATOR_TS1MU1_TO_TE3MU1(GenericTransferlineHierarchy, INIT_LH_BUILDER):
    ...
    def __init__(self):
        ...
        TS1MU1_TO_TE3MU1_device_groups = TS1MU1_TO_TE3MU1_DEVICES()
        GenericTransferlineHierarchy.__init__(self, TS1MU1_TO_TE3MU1_device_groups)

    def __buildSpecial(self):
        self.e_parameter_ts1mu1_to_te3mu1 = self.e_parameter
        self.element_parameter_ts1mu1_to_te3mu1 = self.element_parameter
        self.isotope_parameter_ts1mu1_to_te3mu1 = self.isotope_parameter
        self.q_parameter_ts1mu1_to_te3mu1 = self.q_parameter
    # build special part of hierarchy for TS1MU1_TO_TE3MU1
