...
class TE3MU1_TO_HHTMU1_DEVICES(INIT_GENERIC_TRANSFER_DEVICES):
...
#        INIT_GENERIC_DEVICES.__init__(self)
        ...
        self._rigidity = 18.0
        self._accelerator_zone = "TE3MU1_TO_HHTMU1"

        self._main_dipoles = [ "GHHTMU1" ]
        self._main_quadrupoles = [ "GTH1QD11", "GTH1QD12" ]
...
#       self._main_sextupoles = self._resonance_sextupoles
        ...
        self._vertical_correctors   = [ "GTH1KY1" ]
        self._horizontal_correctors = [ "GTH1KX1" ]
